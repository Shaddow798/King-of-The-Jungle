...
# Clear the screen
# Operting system detection funciton from stack overflow modifed. https://stackoverflow.com/questions/8220108/how-do-i-check-the-operating-system-in-python
...
def rulesScreen():
 ...
 4. If it is not tied the winner will be decide with these combat rules:
    ...
    Elephant beats lion
 5. The winner will be displayed and given a point and the next battle will begin.
